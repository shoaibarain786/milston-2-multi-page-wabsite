...
export default function Footer(){
    return(
      ...
      <li>
        <Link href="https://www.youtube.com/@kiranahmed862"  target="_blank" rel="noopener noreferrer">
          <FontAwesomeIcon icon={faYoutube} className=" text-3xl mr-2  transition duration-200 ease-out hover:scale-105 hover:ease-in" />
        </Link>
      </li>

      <li>
        <Link href="https://www.linkedin.com/in/kiran-ahmed-8064462b7/" target="_blank" rel="noopener noreferrer" >
